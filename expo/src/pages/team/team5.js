            ...
            <div className="content">
                ...
                <div className="team_used">
                    ...
                    <div className="INFO_box">
                        ...
                        최근 다양한 형태의 무인매장을 우리 주변 곳곳에서 흔히 접할 수 있습니다. 바로 최저임금 상승으로 인한 인건비 부담이 가장 큰 원인인데요. 그럼에도 불구하고 무인매장은 도난
에 취약하기 때문에 소상공인들은 쉽사리 무인매장화를 결정하지 못하고 있습니다.그러한 소상공인들을 돕기 위해  값 비싼 도난방지 시스템 대신 최소한의 비용으로 도난상황에 
쉽게 대처할 수 있는 무인매장 모바일 솔루션을 어플리케이션 " Admin"을 기획하였습니다.</div>
                        ...
                        <div className="DESC_box">
                        무인매장 인공지능 솔루션 어플리케이션은 ComputerVision AI 기술을 이용하여 안전한 무인매장 관리 서비스를 제공합니다. 손님과 사장님을 위해 제공되는 두 가지 버전의 어플
리케이션을 통해 편리한 서비스와 효율적인 매장 관리를 실현합니다.
...
덕성전자의 무인매장 솔루션 어플리케이션은 고객들에게 편의를 제공하고, 사장님들에게는 효율적인 매장 관리를 제공합니다. 이를 통해 더욱더 발전된 매장 경험을 제공합니다.
                        </div>
                        ...
                        <div className="DESC_box">
                        RaspberryPi4, Coral Accerelator, Logitec C310
                        </div>
